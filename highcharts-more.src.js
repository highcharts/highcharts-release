...
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(root["_Highcharts"], root["_Highcharts"]["SeriesRegistry"], root["_Highcharts"]["Series"], root["_Highcharts"]["Color"], root["_Highcharts"]["Templating"], root["_Highcharts"]["Point"], root["_Highcharts"]["Chart"], root["_Highcharts"]["SVGElement"], root["_Highcharts"]["StackItem"]);
	else if(typeof define === 'function' && define.amd)
		define("highcharts/highcharts-more", ["highcharts/highcharts"], function (amd1) {return factory(amd1,amd1["SeriesRegistry"],amd1["Series"],amd1["Color"],amd1["Templating"],amd1["Point"],amd1["Chart"],amd1["SVGElement"],amd1["StackItem"]);});
	else if(typeof exports === 'object')
		exports["highcharts/highcharts-more"] = factory(root["_Highcharts"], root["_Highcharts"]["SeriesRegistry"], root["_Highcharts"]["Series"], root["_Highcharts"]["Color"], root["_Highcharts"]["Templating"], root["_Highcharts"]["Point"], root["_Highcharts"]["Chart"], root["_Highcharts"]["SVGElement"], root["_Highcharts"]["StackItem"]);
	else
		root["Highcharts"] = factory(root["Highcharts"], root["Highcharts"]["SeriesRegistry"], root["Highcharts"]["Series"], root["Highcharts"]["Color"], root["Highcharts"]["Templating"], root["Highcharts"]["Point"], root["Highcharts"]["Chart"], root["Highcharts"]["SVGElement"], root["Highcharts"]["StackItem"]);
})(typeof window === 'undefined' ? this : window, (__WEBPACK_EXTERNAL_MODULE__944__, __WEBPACK_EXTERNAL_MODULE__512__, __WEBPACK_EXTERNAL_MODULE__820__, __WEBPACK_EXTERNAL_MODULE__620__, __WEBPACK_EXTERNAL_MODULE__984__, __WEBPACK_EXTERNAL_MODULE__260__, __WEBPACK_EXTERNAL_MODULE__960__, __WEBPACK_EXTERNAL_MODULE__28__, __WEBPACK_EXTERNAL_MODULE__184__) => {
...
const { noop: ColumnSeries_noop } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());



const { clamp, crisp, defined: ColumnSeries_defined, extend: ColumnSeries_extend, fireEvent: ColumnSeries_fireEvent, isArray: ColumnSeries_isArray, isNumber: ColumnSeries_isNumber, merge: ColumnSeries_merge, pick: ColumnSeries_pick, objectEach } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Class
 *
...
class ColumnSeries extends (highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()) {
    ...
    animate(init) {
        ...
        if (init && clipOffset) {
            ...
            series.group.animate({ scaleY: 1 }, ColumnSeries_extend(animObject(series.options.animation), {
 ...
 *
 * */
ColumnSeries.defaultOptions = ColumnSeries_merge((highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()).defaultOptions, Column_ColumnSeriesDefaults);
...
const { crisp: BoxPlotSeries_crisp, extend: BoxPlotSeries_extend, merge: BoxPlotSeries_merge, pick: BoxPlotSeries_pick, relativeLength: BoxPlotSeries_relativeLength } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Class
 *
 ...
 * @augments Highcharts.Series
 */
class BoxPlotSeries extends Column_ColumnSeries {
    /* *
     *
     *  Functions
     *
    ...
    getWhiskerPair(halfWidth, stemX, upperWhiskerLength, lowerWhiskerLength, point) {
        const strokeWidth = point.whiskers.strokeWidth(), getWhisker = (xLen, yPos) => {
            const halfLen = BoxPlotSeries_relativeLength(xLen, 2 * halfWidth) / 2, crispedYPos = BoxPlotSeries_crisp(yPos, strokeWidth);
            return [
                [
                    'M',
                    BoxPlotSeries_crisp(stemX - halfLen),
                    crispedYPos
                ],
                [
                    'L',
    ...
    drawPoints() {
        ...
        for (const point of points) {
            ...
            if (typeof point.plotY !== 'undefined') {
                ...
                let d;
                // The stem
                const stemX = BoxPlotSeries_crisp((point.plotX || 0) + (series.pointXOffset || 0) +
                ...
                if (doQuartiles) {
                    ...
                    q1Plot = BoxPlotSeries_crisp(q1Plot, boxStrokeWidth);
                    q3Plot = BoxPlotSeries_crisp(q3Plot, boxStrokeWidth);
                    x = BoxPlotSeries_crisp(x, boxStrokeWidth);
                    right = BoxPlotSeries_crisp(right, boxStrokeWidth);
                    d = [
                        ['M', x, q3Plot],
                        ['L', x, q1Plot],
                        ['L', right, q1Plot],
                ...
                // The median
                medianPlot = BoxPlotSeries_crisp(point.medianPlot, point.medianShape.strokeWidth());
                d = [
                    ['M', x, medianPlot],
                    ['L', right, medianPlot]
                ];
 ...
 *
 * */
BoxPlotSeries.defaultOptions = BoxPlotSeries_merge(Column_ColumnSeries.defaultOptions, BoxPlot_BoxPlotSeriesDefaults);
...
const { addEvent: BubbleLegendComposition_addEvent, objectEach: BubbleLegendComposition_objectEach, pushUnique, wrap } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/* *
 *
 *  Functions
 *
...
const { seriesTypes: { arearange: ColumnRangeSeries_AreaRangeSeries, column: ColumnRangeSeries_ColumnSeries, column: { prototype: ColumnRangeSeries_columnProto } } } = (highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default());
 ...
 *
 * */
ColumnRangeSeries.defaultOptions = ColumnRangeSeries_merge(ColumnRangeSeries_ColumnSeries.defaultOptions, ColumnRangeSeries_AreaRangeSeries.defaultOptions, columnRangeOptions);
...
class ErrorBarSeries extends BoxPlot_BoxPlotSeries {
    ...
    getColumnMetrics() {
        ...
        return ((series.linkedParent && series.linkedParent.columnMetrics) ||
            Column_ColumnSeries.prototype.getColumnMetrics.call(series));
    }
    drawDataLabels() {
...
const { animObject: SimulationSeriesUtilities_animObject } = (highcharts_commonjs_highcharts_commonjs2_highcharts_root_Highcharts_default());
/**
...
function initDataLabelsDefer() {
    ...
    if (!dlOptions?.defer ||
        ...
        syncTimeout(() => {
            this.deferDataLabels = false;
        }, dlOptions ? SimulationSeriesUtilities_animObject(dlOptions.animation).defer : 0);
    }
}
/**
 ...
 *
 * */
class WaterfallPoint extends Column_ColumnSeries.prototype.pointClass {
    /* *
     *
     *  Functions
     *
