...
const { parse: ColumnSeries_color } = (highcharts_Color_commonjs_highcharts_Color_commonjs2_highcharts_Color_root_Highcharts_Color_default());
 ...
 * @augments Highcharts.Series
 */
class ColumnSeries_ColumnSeries extends (highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()) {
    /* *
     *
     *  Functions
     *
 ...
 *
 * */
ColumnSeries_ColumnSeries.defaultOptions = ColumnSeries_merge((highcharts_Series_commonjs_highcharts_Series_commonjs2_highcharts_Series_root_Highcharts_Series_default()).defaultOptions, Column_ColumnSeriesDefaults);
ColumnSeries_extend(ColumnSeries_ColumnSeries.prototype, {
...
highcharts_SeriesRegistry_commonjs_highcharts_SeriesRegistry_commonjs2_highcharts_SeriesRegistry_root_Highcharts_SeriesRegistry_default().registerSeriesType('column', ColumnSeries_ColumnSeries);
/* *
 *
 *  Default Export
 *
 * */
/* harmony default export */ const Column_ColumnSeries = (ColumnSeries_ColumnSeries);
/* *
 *
 *  API Declarations
 *
